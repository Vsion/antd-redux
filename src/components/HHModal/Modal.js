...
const HHModal = React.createClass({
   ...
   render() {
     ...
     let height = this.props.isFullModel ? modalHeight : "auto";
     return (
       <Modal ref="modal" title={this.props.title} visible={this.props.visible}
         onOk={this.props.onOk} onCancel={this.props.onCancel}
         maskClosable={false}
         width={this.props.width}
         style={{maxHeight: modalHeight, height: height}}
         footer={[
